...
public class AdminFunctions {
	...
	public static void addShare(){
		...
		System.out.println("Enter Share Name(Share Name is case sensitive) : ");
		...
		if(allShareDetails.containsKey(shareName))	{
			...
			System.out.println("Share name cannot be blank" );
			return;
		}
			...
			System.out.println("Share name should not contain comma. You will be returned to main menu" );
			return;
		}
		...
		if(shareQuantity<0){
			System.out.println("Quantity can't be negative number.You will be returned to main menu" +'\n');
			return;
		}
		...
		if(sharePrice<0){
			System.out.println("Price can't be negative number.You will be returned to main menu" +'\n');
			return;
		}
	...
	public static void updateShareQuantity(){
		...
		System.out.println('\n' + "Enter Share Name(Share Name is case sensitive) for updating quantity: ");
		String shareName = input.next();
	...
	public static void updateSharePrice(){
		...
		System.out.println('\n'+"Enter Share Name(Share Name is case sensitive) for updating price : ");
		...
		if(updateSharePrice <0){
			System.out.println("Share price can't be negative number. You will be returned to main menu" +'\n');
			return;
		}
