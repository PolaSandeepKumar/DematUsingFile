...
public class CustomerFunctions {
	...
	public static void sellShares(int accountNumber) {
		...
		if(sellQuantity>currentUserHoldings || sellQuantity<0) {
			System.out.println("Please enter valid sell quantity as per the available shares (Value should not be negative). You will be returned to main menu" +'\n');
			return;
		}
	...
	public static void viewTransactionReport(int userAccountNumber) {
		...
		System.out.println("Enter O to view transactions Date wise and any number to view transactions Share wise");
		boolean wrongInput1 = false;
		int choice9 = 0;
		do {
			try {
				wrongInput1= false;
				choice9 = userInput.nextInt();		
			}catch(InputMismatchException exception) {
				wrongInput1 = true;
				System.out.println("Input choice is not a number");
				System.out.println("Enter O to view transactions Date wise and any number to view transactions Share wise");
		...
		if (sDate.isAfter(eDate)) {
			...
			List<UserTransaction> userTransactionDetailsList = UserTransactionHashMap.getUserTransactionList(userAccountNumber, sDate, eDate);
			...
			// List of Strings used to display share names and transaction names based on selected share
			...
			List<UserTransaction> shareTransactionDetailsList = UserTransactionHashMap
					.getUserTransactionList(userAccountNumber, selectedShareName);
