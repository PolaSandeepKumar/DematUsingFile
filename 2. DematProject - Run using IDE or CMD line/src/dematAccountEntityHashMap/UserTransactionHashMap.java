...
public class UserTransactionHashMap {
	...
	public static List <UserTransaction> getUserTransactionList(int accountNumber, String shareName){
	...
	public static List <UserTransaction> getUserTransactionList(int accountNumber, LocalDate startDate, LocalDate endDate){
